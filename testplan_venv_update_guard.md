...
### 3.1 Simulate “next release needs another Python”

While services are running (or stopped — both are useful):

```bash
cd /root/kittyhack
cp setup/REQUIRED_PYTHON /tmp/REQUIRED_PYTHON.bak
echo "3.12" > setup/REQUIRED_PYTHON   # or 3.13 if you want to exercise Trixie-era path
```
